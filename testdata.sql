...
VALUES (
  ...
  (  212,
    ...
    'Народився 7 липня 1927 року у селі Холопковому (нині село Перемога Шосткинського району Сумської області, Україна) у заможній селянській багатодітній сімї. Після розкуркулення 1930 року його сімя втекла до Грузії, де батько працював на копальні поблизу міста Поті. Згодом батька відправили до табору в Комі. Після цих подій матір разом з дітьми повернулися назад до рідного села, де їм було надано притулок. Через деякий час сімя переселилася до Глухова[1].
  ...
  (  218,
    ...
    У 1988 році Михайло Дідишин спорудив біля музею памятник О    лексі Довбушу.
